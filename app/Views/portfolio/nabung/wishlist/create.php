            ...
            <div class="container mt-5 shadow" style="background-color:smoke;border-radius:20px;width:800px;">
                <div class="row">
                    <div class="col mb-5" style="margin: 35px 0 20px 40px;">
                        <h4 class="d-inline-block w-5" style="margin-bottom: 25px;">Tambah Wishlist</h4>
                        <form method="POST" action="/wishlist/save">
                            <?= csrf_field(); ?>
                            <div class="form-group">
                                <label class="ml-3" for="nama">Nama</label>
                                <div class="col-10">
                                    <input type="text" class="form-control" id="nama" aria-describedby="namaBarang" name="nama" autofocus required value="<?= old('nama'); ?>">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-10">
                                    <input type="text" class="form-control  <?= ($val->hasError('harga')) ? 'is-invalid' : ''; ?>" id="harga" aria-describedby="hargaBarang" required name="harga" value="<?= old('harga'); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-10">
                                    <input type="date" class="form-control" id="target" aria-describedby="target" required name="target" value="<?= old('date'); ?>">
                                </div>
                    ...
                    <div class="col-md-5" style="border-radius: 0px 20px 20px 0px;">
                        <img src="<?= base_url('img/coba.jpg'); ?>" class="mt-4" style="height:inherit;width:inherit">
                    </div>
                </div>
            </div>
        </div>
