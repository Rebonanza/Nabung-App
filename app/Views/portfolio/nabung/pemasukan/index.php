...
<div class="row">
    <div class="col">
        <div class="container mt-5">
            ...
            <?php endif; ?>
            <a href="/pemasukan/create" class="btn btn-success mt-3">Tambah Data</a>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row text-right">
                                            <div class="col text-right mt-1">
                                                <a href="<?= base_url('pemasukan/edit/' . $row['id']); ?>" class="btn btn-warning btn-sm d-inline mr-2"><i class="far fa-edit"></i>Edit</a>
                                                <form action="<?= base_url('pemasukan/delete/' . $row['id']); ?>" method="post" style="display: inline">
