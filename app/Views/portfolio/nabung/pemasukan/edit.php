            ...
            <div class="container mt-5 shadow" style="background-color:smoke;border-radius:20px;width:800px;">
                <div class="row">
                    <div class="col mb-5" style="margin: 35px 0 20px 40px;">
                        <h4 class="d-inline-block w-5" style="margin-bottom: 25px;">Edit Pemasukan</h4>
                        <form method="POST" action="/pemasukan/update/<?= $pemasukan['id']; ?>">
                            <?= csrf_field(); ?>
                            <div class="form-group">
                                <label class="ml-3" for="catatan">Catatan</label>
                                <div class="col-10">
                                    <input type="text" class="form-control" id="catatan" aria-describedby="catatanPemasukan" name="catatan" autofocus required value="<?= $pemasukan['catatan']; ?>">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-10">
                                    <input type="text" class="form-control  <?= ($val->hasError('harga')) ? 'is-invalid' : ''; ?>" id="harga" aria-describedby="jumlahUang" id="harga" required name="jumlah" value="<?= $pemasukan['jumlah']; ?>">
