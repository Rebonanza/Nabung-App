            ...
            <div class="container mt-5 shadow" style="background-color:smoke;border-radius:20px;width:750px;">
                <div class="row">
                    <div class="col mb-5" style="margin: 35px 0 10px 40px;">
                        <h4 class="d-inline-block w-5" style="margin-bottom: 25px;">Tambah Pengeluaran</h4>
                        <form method="POST" action="/pengeluaran/save">
                            <?= csrf_field(); ?>
                            <div class="form-group">
                                <label class="ml-3" for="catatan">Catatan</label>
                                <div class="col-10">
                                    <input type="text" class="form-control" id="catatan" aria-describedby="catatanpengeluaran" name="catatan" autofocus required value="<?= old('catatan'); ?>">
                                </div>
